...
namespace ConquerServer_v2.Database
{
    public unsafe partial class ServerDatabase
    {
        ...
        public static bool LoadPlayer(GameClient Client, int PasswordCheckSum, out bool NewCharacter)
        {
            ...
            if (rdr.ReadString("Account", "Password", "", 16).GetHashCode() == PasswordCheckSum)
            {
                try
                {
                    ...
                    if (rdrName != "INVALIDNAME")
                    {
                        ...
                        Client.Entity.Level = Math.Min((ushort)137, rdr.ReadUInt16("Character", "Level", 1));
                        ...
                        Client.Manapoints = rdr.ReadUInt16("Character", "Mana", 0);
