                        ...
                        case "@item":
                            {
                                if (Client.Inventory.ItemCount < 40)
                                {
                                    ...
                                    if (ID != 0 && Client.AdminFlag >= Flag)
                                    {
                                        ...
                                        {
                                            item.Plus = Client.AdminFlag >= 1 ? Math.Min(byte.Parse(Commands[3]), (byte)12) : Math.Min(byte.Parse(Commands[3]), (byte)9);
                                            if (Commands.Length > 4)
                                            {
                                                ...
                                                if (Commands.Length > 5)
                                                {
                                                    ...
                                                    {
                                                        if (byte.Parse(Commands[6]) >= 1 && byte.Parse(Commands[6]) <= 3 ||
                                                            byte.Parse(Commands[6]) >= 11 && byte.Parse(Commands[6]) <= 13 ||
                                                            byte.Parse(Commands[6]) >= 21 && byte.Parse(Commands[6]) <= 23 ||
                                                            byte.Parse(Commands[6]) >= 31 && byte.Parse(Commands[6]) <= 33 ||
                                                            byte.Parse(Commands[6]) >= 41 && byte.Parse(Commands[6]) <= 43 ||
                                                            byte.Parse(Commands[6]) >= 51 && byte.Parse(Commands[6]) <= 53 ||
                                                            byte.Parse(Commands[6]) >= 61 && byte.Parse(Commands[6]) <= 63 ||
                                                            byte.Parse(Commands[6]) >= 71 && byte.Parse(Commands[6]) <= 73 ||
                                                            byte.Parse(Commands[6]) >= 101 && byte.Parse(Commands[6]) <= 103 ||
                                                            byte.Parse(Commands[6]) >= 121 && byte.Parse(Commands[6]) <= 123)
                                                            item.SocketOne = byte.Parse(Commands[6]);
                                                        if (Commands.Length > 7)
                                                        {
                                                            if (byte.Parse(Commands[7]) >= 1 && byte.Parse(Commands[7]) <= 3 ||
                                                                byte.Parse(Commands[7]) >= 11 && byte.Parse(Commands[7]) <= 13 ||
                                                                byte.Parse(Commands[7]) >= 21 && byte.Parse(Commands[7]) <= 23 ||
                                                                byte.Parse(Commands[7]) >= 31 && byte.Parse(Commands[7]) <= 33 ||
                                                                byte.Parse(Commands[7]) >= 41 && byte.Parse(Commands[7]) <= 43 ||
                                                                byte.Parse(Commands[7]) >= 51 && byte.Parse(Commands[7]) <= 53 ||
                                                                byte.Parse(Commands[7]) >= 61 && byte.Parse(Commands[7]) <= 63 ||
                                                                byte.Parse(Commands[7]) >= 71 && byte.Parse(Commands[7]) <= 73 ||
                                                                byte.Parse(Commands[7]) >= 101 && byte.Parse(Commands[7]) <= 103 ||
                                                                byte.Parse(Commands[7]) >= 121 && byte.Parse(Commands[7]) <= 123)
