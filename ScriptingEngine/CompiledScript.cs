    ...
    public class CompiledScript : MarshalByRefObject
    {
        internal CompiledScript(string startFile, CompilerResults compiledResults)
        {
            ...
            if (this.Errors.Length == 0)
                this.CompiledAssembly = compiledResults.CompiledAssembly;
        ...
        {
            return this.CompiledAssembly.GetType(TypeName);
        }
        ...
        public bool Success { get { return this.CompiledAssembly != null; } }
